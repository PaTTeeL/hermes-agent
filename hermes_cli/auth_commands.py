...
def _format_remaining(reset_at: float) -> str:
    """Format a wall-clock reset_at timestamp as human-readable remaining time."""
    remaining = max(0, int(math.ceil(reset_at - time.time())))
    if remaining == 0:
